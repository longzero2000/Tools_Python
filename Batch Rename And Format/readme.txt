Tool đổi tên và đổi định dạng file hàng loạt
Một số lưu ý:
Cây thư mục có dạng:
- Zero_Tools.exe
- data
	- img.png
	- img 2.png
+ Những file cần xử lý nếu nằm trong thư mục tên "data" thì đường dẫn khi nhập có dạng "data".
...
- data
	- img.png
	- img 2.png
+ The files to be processed if located in the directory named "data", the path when importing is in the form "data".
